...
func (rtm *RoleManagerTracing) RemoveMemberFromEntity(ctx context.Context, session authn.Session, entityID string, memberID string) error {
	return rtm.roles.RemoveMemberFromEntity(ctx, session, entityID, memberID)
}
